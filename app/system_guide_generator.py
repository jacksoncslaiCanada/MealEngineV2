...
def _resolve_image(supabase_url: str, name: str, description: str) -> str:
    ...
    Strategy:
      1. If supabase_url given, try fetching the pre-generated image (fast path).
      2. If missing or no URL, call Flux Schnell to generate one on the fly.
    ...
    if supabase_url:
        ...
        logger.info("system_guide_generator: no Supabase URL for %s — generating via Flux", name)
